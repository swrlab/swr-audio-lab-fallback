...
app.get('/narrativenews/swr3news.xml', function (req, res) {
	res.redirect('https://cdn-static.lab.swr.de/radiohub/v2/content/feed/single/rss/swr3-news?d=narrativenews-redirect')
})

app.get('/narrativenews/swraktuell.xml', function (req, res) {
	res.redirect('https://cdn-static.lab.swr.de/radiohub/v2/content/feed/single/rss/swraktuell-news?d=narrativenews-redirect')
})
...
app.get('/re/:slug', async (req, res, next) => { try {
